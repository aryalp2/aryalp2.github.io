class HeapSort extends ParentSort{
    ...
    swapHeap(i,j)
    {
        ...
        this.barVisualizationUpdate(barProperty[i],barHeights[i],"blue");//Color update
        this.barVisualizationUpdate(barProperty[j],barHeights[j],"blue");//Color update
    }
    ...
    maximumHeapifySorting(n,i)
    {
        ...
        if(l<n && barHeights[l]>barHeights[largest])
        {
            if(largest!=i)
            {
                this.barVisualizationUpdate(barProperty[largest],barHeights[largest],"blue");//Color update
            }
